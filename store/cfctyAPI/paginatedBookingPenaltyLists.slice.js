...
const paginatedBookingPenaltyListsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(modules_booking_penalties_list.pending, (state, action) => {
        if (state.api.loading === "idle") {
          state.api.loading = "pending"
        }
      })
      .addCase(modules_booking_penalties_list.fulfilled, (state, action) => {
      ...
      .addCase(modules_booking_penalties_list.rejected, (state, action) => {
        if (state.api.loading === "pending") {
