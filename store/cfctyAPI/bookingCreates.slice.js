...
const bookingCreatesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(
        modules_booking_create_booking_create.pending,
        (state, action) => {
      ...
      .addCase(
        modules_booking_create_booking_create.fulfilled,
        (state, action) => {
      ...
      .addCase(
        modules_booking_create_booking_create.rejected,
        (state, action) => {
          if (state.api.loading === "pending") {
      ...
      .addCase(
        modules_booking_create_booking_retrieve.pending,
        (state, action) => {
          if (state.api.loading === "idle") {
            state.api.loading = "pending"
          }
      ...
      .addCase(
        modules_booking_create_booking_retrieve.fulfilled,
        (state, action) => {
          if (state.api.loading === "pending") {
            state.entities = [
      ...
      .addCase(
        modules_booking_create_booking_retrieve.rejected,
        (state, action) => {
          if (state.api.loading === "pending") {
            state.api.error = action.error
            state.api.loading = "idle"
      ...
      .addCase(
        modules_booking_create_booking_update.pending,
        (state, action) => {
          if (state.api.loading === "idle") {
            state.api.loading = "pending"
          }
      ...
      .addCase(
        modules_booking_create_booking_update.fulfilled,
        (state, action) => {
          if (state.api.loading === "pending") {
      ...
      .addCase(
        modules_booking_create_booking_update.rejected,
        (state, action) => {
          if (state.api.loading === "pending") {
            state.api.error = action.error
            state.api.loading = "idle"
      ...
      .addCase(
        modules_booking_create_booking_destroy.pending,
        (state, action) => {
          if (state.api.loading === "idle") {
            state.api.loading = "pending"
          }
      ...
      .addCase(
        modules_booking_create_booking_destroy.fulfilled,
        (state, action) => {
          if (state.api.loading === "pending") {
      ...
      .addCase(
        modules_booking_create_booking_destroy.rejected,
        (state, action) => {
          if (state.api.loading === "pending") {
            state.api.error = action.error
            state.api.loading = "idle"
